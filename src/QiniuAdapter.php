...
namespace Ftlh2005\Flysystem\Qiniu;
...
class QiniuAdapter implements FilesystemAdapter
{
    ...
    public function fetch(string $path, string $url)
    {
     ...
     */
    public function getTemporaryUrl($path, $expiration): string
    {
    ...
    public function refresh($path): array
    {
        // 将 $path 变成完整的 url
